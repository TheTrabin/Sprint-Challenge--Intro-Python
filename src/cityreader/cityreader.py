...
l1 = input(f'Type your first latitude, longitude cordinates seperated by commas:')
l2 = input(f'Type your second latitude, longitude cordinates seperated by commas:')
